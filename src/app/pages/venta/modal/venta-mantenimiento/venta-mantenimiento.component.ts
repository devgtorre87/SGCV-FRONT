...
@Component({
  selector: 'app-venta-mantenimiento',
  templateUrl: './venta-mantenimiento.component.html',
  styleUrl: './venta-mantenimiento.component.css'
})
export class VentaMantenimientoComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<VentaMantenimientoComponent>,
